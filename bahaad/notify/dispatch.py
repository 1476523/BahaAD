...
def send_notification(
    ...
    **context: object,
    ...
    #   - 版本更新通知：`prebuilt_html`（release notes 轉成 `<blockquote expandable>`＋
    #     `<a href>`，見 scheduler/version_check.py，使用者 2026-09-10）
    prebuilt = context.get("full_list_html") or context.get("prebuilt_html")
    if category in ("newanime_full_list", "system_new_version") and prebuilt:
